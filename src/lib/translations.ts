...
export const t = {
  es: {
    ...
    about: {
      ...
      visionLabel: "Visión",
      vision: "Ser reconocida como un negocio social que es un centro modelo que promueva el consumo de alimentos sostenibles, principios de agroecología, energías renovables, una institución eco-amigable que ofrezca sensibilización al público y tranquilidad, calidad y esparcimiento en un lugar natural, disfrutando la belleza de la creación de Dios.",
      stat1: "4,100+",
