...
export const t = {
  es: {
    ...
    accommodation: {
      ...
      phone: "966 721 057",
      breakfastAddon: "Desayuno continental disponible",
      alsoAvailable: "También disponible en",
      checkIn: "Llegada: 14:00 – 15:30",
      checkOut: "Salida: 08:00 – 11:00",
      bookingNote: "Se requiere reserva con al menos 1 día de anticipación. No se aceptan reservas el mismo día.",
      rulesNote: "No se permiten mascotas · No se permite fumar · Silencio: 22:00 – 07:00",
      formCheckin: "Llegada",
      formCheckout: "Salida",
      formAdults: "Adultos",
      formChildren: "Niños",
      ...
      buildings: [
        ...
        },
        {
          id: "casona",
          name: "Casona de Paz",
          subtitle: "Casa colonial de campo",
          description: "Casa colonial de dos plantas en el corazón del valle de Tomaykichwa, a 45 minutos de Huánuco. Cuenta con terraza, jardines, sala común con TV, área de juegos infantiles y restaurante en sitio. Desayuno continental incluido. Perfecta para familias, parejas y grupos.",
          features: ["Desayuno continental incluido", "WiFi gratuito", "Estacionamiento privado gratuito", "Restaurante en sitio (cocina peruana)", "Terraza y jardín", "Sala común con TV", "Área de juegos infantiles", "Cunas disponibles sin costo", "Niños de todas las edades bienvenidos", "Seguridad 24 horas"],
      ...
      rooms: [
        {
          ...
          description: "Bungalow privado con cama doble matrimonial, rodeado de árboles frutales y vistas al jardín. Hasta 2 personas.",
          features: ["1 cama doble matrimonial", "Hasta 2 huéspedes", "Baño privado con ducha", "Amenidades de baño gratuitas", "Ropa de cama y toallas", "Hervidor eléctrico", "Refrigeradora", "WiFi gratuito"],
        ...
        },
        {
          ...
          description: "Bungalow con 4 camas individuales en litera, ideal para grupos pequeños y familias. Hasta 4 personas.",
          features: ["4 camas individuales (2 literas)", "Hasta 4 huéspedes", "Baño privado con ducha", "Amenidades de baño gratuitas", "Ropa de cama y toallas", "Hervidor eléctrico", "Armario y perchero", "WiFi gratuito"],
          img: "/images/hospedaje_habitacion_twin.jpg",
        },
        {
          id: "casona-matrimonial",
          buildingId: "casona",
          building: "Casona de Paz",
          title: "Habitación Matrimonial",
          description: "Habitación doble en la Casona colonial con acceso a terraza, jardines y sala común. Hasta 2 personas.",
          features: ["1 cama doble matrimonial", "Hasta 2 huéspedes", "Baño privado con ducha", "Amenidades de baño gratuitas", "Ropa de cama y toallas", "Armario", "Hervidor eléctrico", "WiFi gratuito"],
          img: "/images/hospedaje_habitacion_doble.jpg",
        },
        {
          id: "casona-litera",
          ...
          building: "Casona de Paz",
          title: "Habitación Grupal",
          description: "Habitación con camas en litera en la Casona, perfecta para familias y grupos. Hasta 4 personas.",
          features: ["4 camas individuales (2 literas)", "Hasta 4 huéspedes", "Baño privado con ducha", "Amenidades de baño gratuitas", "Ropa de cama y toallas", "Hervidor eléctrico", "Refrigeradora", "Armario y perchero", "Terraza compartida", "WiFi gratuito"],
          img: "/images/hospedaje_habitacion_twin.jpg",
        },
      ],
    },
    ...
    volunteer: {
      label: "Voluntariado & Pasantías",
      title: "Haz un impacto real en Tomaykichwa",
      subtitle: "Trabaja en la granja, vive en la comunidad y forma parte de algo más grande — un proyecto que restaura vidas a través de la naturaleza.",
      andemos: "Programa Andemos",
      andemosSub: "Paz y Esperanza Internacional",
      andemosCta: "Ver programa completo",
      andemos_url: "https://andemos.peaceandhopeinternational.org/es/inicio/",
      whyCta: "¿Por qué voluntariarse aquí?",
      roles: [
        {
          icon: "🌱",
          title: "Agroecología y Huerto",
          desc: "Siembra, cuida y cosecha en nuestros huertos orgánicos. Aprende técnicas de agricultura ecológica de la mano de nuestro equipo.",
        },
        {
          icon: "🐄",
          title: "Cuidado de Animales",
          desc: "Ayuda en el cuidado diario de vacas, alpacas, cuyes y aves de corral. Aprende sobre ganadería ecológica y bienestar animal.",
        },
        {
          icon: "🧀",
          title: "Producción Artesanal",
          desc: "Participa en la elaboración de quesos, yogures, manjarblanco y otros productos naturales que vendemos en nuestra tienda.",
        },
        {
          icon: "🤝",
          title: "Programas Comunitarios",
          desc: "Apoya las actividades y talleres que benefician a niños, jóvenes y familias de Tomaykichwa vinculados a los proyectos de Paz y Esperanza.",
        },
      ],
      ...
      applyBody: "El proceso de voluntariado está gestionado por el programa Andemos de Paz y Esperanza Internacional. Completa tu solicitud en su sitio web o escríbenos directamente por WhatsApp para coordinar tu llegada.",
      applyWhatsApp: "Escríbenos por WhatsApp",
      applyAndemos: "Solicitud en Andemos",
    },
    footer: {
  ...
  en: {
    ...
    accommodation: {
      ...
      phone: "966 721 057",
      breakfastAddon: "Continental breakfast available",
      alsoAvailable: "Also available at",
      checkIn: "Check-in: 2:00 PM – 3:30 PM",
      checkOut: "Check-out: 8:00 AM – 11:00 AM",
      bookingNote: "Reservations required at least 1 day in advance. Same-day bookings not accepted.",
      rulesNote: "No pets · No smoking · Quiet hours: 10:00 PM – 7:00 AM",
      ...
      buildings: [
        ...
        },
        {
          id: "casona",
          name: "Casona de Paz",
          subtitle: "Colonial farmhouse",
          description: "Two-story colonial house in the heart of the Tomaykichwa valley, 45 minutes from Huánuco city. Features a terrace, gardens, shared TV lounge, children's playground, and an on-site restaurant. Continental breakfast included. A great fit for families, couples, and groups.",
          features: ["Continental breakfast included", "Free WiFi", "Free private parking", "On-site restaurant (Peruvian cuisine)", "Terrace & garden", "Shared TV lounge", "Children's playground", "Free cribs on request", "Children of all ages welcome", "24-hour security"],
          img: "/images/hospedaje_edificio_principal.jpg",
        },
      ],
      rooms: [
        {
          ...
          description: "Private bungalow with a double bed, surrounded by fruit trees and garden views. Up to 2 guests.",
          features: ["1 double bed", "Up to 2 guests", "Private bathroom with shower", "Free toiletries", "Fresh linens & towels", "Electric kettle", "Refrigerator", "Free WiFi"],
          img: "/images/hospedaje_habitacion_doble.jpg",
        },
        {
          id: "bungalow-litera",
          ...
          building: "Bungalow",
          title: "Group Room",
          description: "Bungalow with 4 single bunk beds, ideal for small groups and families. Up to 4 guests.",
          features: ["4 single beds (2 bunks)", "Up to 4 guests", "Private bathroom with shower", "Free toiletries", "Fresh linens & towels", "Electric kettle", "Refrigerator", "Wardrobe & coat rack", "Free WiFi"],
          img: "/images/hospedaje_habitacion_twin.jpg",
        },
        {
          id: "casona-matrimonial",
          ...
          building: "Casona de Paz",
          title: "Matrimonial Room",
          description: "Double room in the colonial farmhouse with access to the terrace and farm gardens. Up to 2 guests.",
          features: ["1 double bed", "Up to 2 guests", "Private bathroom with shower", "Free toiletries", "Fresh linens & towels", "Wardrobe", "Electric kettle", "Free WiFi"],
          img: "/images/hospedaje_habitacion_doble.jpg",
        },
        {
          id: "casona-litera",
          ...
          building: "Casona de Paz",
          title: "Group Room",
          description: "Bunk room in the Casona, perfect for families and groups. Up to 4 guests.",
          features: ["4 single beds (2 bunks)", "Up to 4 guests", "Private bathroom with shower", "Free toiletries", "Fresh linens & towels", "Electric kettle", "Refrigerator", "Wardrobe & coat rack", "Shared terrace", "Free WiFi"],
          img: "/images/hospedaje_habitacion_twin.jpg",
        },
      ],
    },
    ...
    volunteer: {
      label: "Volunteering & Internships",
      title: "Make a real impact in Tomaykichwa",
      subtitle: "Work on the farm, live in the community, and be part of something bigger — a project that restores lives through nature.",
      andemos: "Andemos Program",
      andemosSub: "Peace & Hope International",
      andemosCta: "View full program",
      andemos_url: "https://andemos.peaceandhopeinternational.org/es/inicio/",
      whyCta: "Why volunteer here?",
      roles: [
        {
          icon: "🌱",
          title: "Agroecology & Garden",
          desc: "Plant, tend, and harvest in our organic gardens. Learn ecological farming techniques alongside our team.",
        },
        {
          icon: "🐄",
          title: "Animal Care",
          desc: "Help with the daily care of cows, alpacas, guinea pigs, and poultry. Learn about ecological livestock management and animal welfare.",
        },
        {
          icon: "🧀",
          title: "Artisan Production",
          desc: "Take part in making cheeses, yogurt, dulce de leche, and other natural products we sell in our farm store.",
        },
        {
          icon: "🤝",
          title: "Community Programs",
          desc: "Support activities and workshops that benefit children, youth, and families in Tomaykichwa through the Peace & Hope projects.",
        },
      ],
      offerTitle: "What we offer",
      offers: [
        "On-farm accommodation (subject to availability)",
        "Meals made with fresh farm produce",
        "Cultural immersion in Tomaykichwa, Huánuco",
        "Letter of recommendation upon completion",
        "Hands-on experience in agroecology and social enterprise",
      ],
      ...
      applyBody: "The volunteer process is managed by the Andemos program of Peace & Hope International. Complete your application on their website or message us directly on WhatsApp to coordinate your arrival.",
      applyWhatsApp: "Message us on WhatsApp",
      applyAndemos: "Apply via Andemos",
    },
    footer: {
